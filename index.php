...
<head itemscope itemtype="http://www.schema.org/website">
	<title>Online Offset Printing Sale | Sivakasi Offset Printers | Printing Discount Sale |
				...
				<div class="row">
					<div class="col-12">
						<div class="marquee L text-light text-center smallfnt">
							Grand sale is open now. Buy early for the best discounts! Order now!
		...
		<nav id="my-nav" class="navbar navbar-expand-lg navbar-light sticky-top">
			<div class="container-fluid">
				<a class="navbar-brand text-blu" href="index.php">
					<img class="logo rounded-circle" src="./images/logo.webp" alt="Demo Printz" title="Demo Printz">
					<em class="text-white">Demo</em> <em class="text-yellow">Printz</em>
				</a>
	...
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div
					class="p-3 p-md-0 text-center text-md-left index-image-container d-flex align-items-center justify-content-center">
					<div class="text-container text-white font-weight-bold wow zoomInRight">
						<h1 class="text-center"><span class="sour-gummy-serif text-main">Demo</span> Printz</h1>
						<p class="text-light">Bringing Your <span class="text-main">Vision to Print</span></p>
					</div>
				</div>
			</div>
			<div class="carousel-item">
				<div
					class="p-3 p-md-0 text-center text-md-left index-image-container-two d-flex align-items-center justify-content-center">
					<div class="text-container font-weight-bold wow slideInDown">
						<h2 class="text-center text-main"><span class="sour-gummy-serif text-white">Demo</span> Printz
						</h2>
						<p class="text-white">Elevate Your Brand With <span class="text-main">Precision Printing</span>
						</p>
					</div>
				</div>
			</div>
	...
	<section class="index-one pad wow fadeInUp" id="services">
		<div class="container text-center">
			...
			<p class="text-center mt-4">We are one of the leading wholesale offset printers and dealer in printing
				allied
				products.
			<div class="row three-card-container align-items-center justify-items-center text-justify">
				<div class="col-12 col-md-4 col-lg-4">
					<div class="card-one">
						...
						<h4 class="h6 small-title font-weight-bold font-weight-bold text-uppercase">Offer</h4>
						<h5 class="h4 font-weight-bold">Printing Services</h5>
				...
				<div class="col-12 col-md-4 col-lg-4">
					<div class="card-one">
						...
						<h4 class="h6 small-title font-weight-bold font-weight-bold text-uppercase">Offer</h4>
						<h5 class="h4 font-weight-bold">Designing Services</h5>
						<p class="card-text">Reliable, high-quality printing services for customized, efficient,
							versatile solutions
					</div>
				</div>
				<div class="col-12 col-md-4 col-lg-4">
					<div class="card-one">
						...
						<h4 class="h6 small-title font-weight-bold font-weight-bold text-uppercase">Offer</h4>
						<h5 class="h4 font-weight-bold">Promotional Products</h5>
						<p class="card-text">Reliable, high-quality printing services for customized, efficient,
							versatile solutions
					</div>
				</div>
